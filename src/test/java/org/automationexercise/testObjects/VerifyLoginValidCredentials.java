package org.automationexercise.testObjects;
...
public class VerifyLoginValidCredentials extends BaseClass {
			...
			//	WebElement signupButtonElement = wait.until(ExpectedConditions.elementToBeClickable(signupButton));
		     ...
		     //  DeleteAccountButtonElement.click();
		      ...
		      JavascriptExecutor js5 = (JavascriptExecutor) driver;
		        ...
		        driver.findElement(loginEmail).sendKeys(readProperty("email"));
		        driver.findElement(EnterPassword2).sendKeys(readProperty("password"));
				//	WebElement signupButtonElement = wait.until(ExpectedConditions.elementToBeClickable(signupButton));
			      //  signupButtonElement.click();
